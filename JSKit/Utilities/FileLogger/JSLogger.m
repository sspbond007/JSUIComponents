...
- (NSInteger)nextFileCounter
{
    ...
    if (existingLogFiles.count >= MaxFileAllowed) {
        NSString *filePath = [[self storageDirectory] stringByAppendingPathComponent:[NSString stringWithFormat:@"application%ld.log.zip", [[existingLogFiles firstObject] integerValue]]];
